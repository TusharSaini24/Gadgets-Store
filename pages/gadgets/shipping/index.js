...
const ShippingScreen = () => {
  ...
  useEffect(() => {
    if (!Cookies.get("user")) {
      toast("please login and shop first");
      setTimeout(() => {
        router.push("/");
      }, 1000);
    }
  ...
  const handlePlaceOrder = async () => {
    if (paymentMethod === "stripe" && paymentResult === null) {
      toast("Payment is not done yet !!!");
    } else {
      if (paymentMethod === "stripe") {
        ...
        try {
          ...
          if (res.status === 200) {
            ...
            toast.error("order has not been place ");
          }
          setAddress("");
          setCity("");
          setPostalCode("");
              ...
              <div className="flex flex-col flex-wrap -m-2">
                ...
                <div className="p-2 w-1/2">
                  <div className="pl-2 flex flex-col gap-1 relative border-2 ">
                    ...
                    <span>
                      Total Price : &#x20B9;{totalPrice + taxPrice + 100}
                    </span>
                  </div>
                </div>
